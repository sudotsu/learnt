...
export default function AddForm({ type, groups }: { type: ItemType; groups: GroupDef[] }) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 8, padding: "0 12px 12px" }}>
      {/* Group / subgroup row */}
      ...
      <div style={{ display: "flex", gap: 8 }}>
        ...
        <button
          ...
          style={{
            ...
            border: "none",
            cursor: pending || !resolvedGroup ? "not-allowed" : "pointer",
            borderRadius: 4,
            padding: "8px 14px",
            fontFamily: "var(--mono)",
            fontSize: 11,
        ...
        <button
          ...
          style={{
            background: "none", border: "none", cursor: "pointer",
            fontSize: 18, color: "var(--mu)", padding: "0 4px",
          }}
        >
          ×
        </button>

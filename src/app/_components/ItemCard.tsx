    ...
    <>
      {parts.map((part, i) =>
        part.toLowerCase() === query.toLowerCase() ? (
          <mark
            key={i}
            style={{ background: "rgba(240,165,0,0.28)", color: "inherit", borderRadius: 2, padding: "0 1px" }}
          >
            {part}
          </mark>
        ) : (
      ...
      <div className="item" style={cardStyle}>
        ...
        <button
          ...
          style={{
            ...
            color: "var(--g)", padding: "0 3px", flexShrink: 0,
            opacity: pending ? 0.4 : 1, transition: "opacity 0.12s",
          }}
        >
          {pending ? "·" : "✓"}
        </button>
